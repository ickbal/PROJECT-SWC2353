                            ...
                            if(isset($_SESSION['cart'])&&(count($_SESSION['cart'])>0))
                            {
                                ...
                                foreach($_SESSION['cart'] as $item)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-price" data-title="Price"><span class="currency-symbol">RM'.number_format($item[3]).'</span></td>
                                        <td class="product-price" data-title="quantity"><span class="currency-symbol">'.$item[4].'</span></td>
                                        <td class="product-subtotal" data-title="Subtotal"><span class="currency-symbol">RM'.number_format($total).'</span></td>
                                    </tr>
                                    </tbody>
                                    ';
                                    $total_final +=$total;
                                                        ...
                                                        <table class="table summery-table mb--30">
                                                            <tbody>
                                                                <tr class="order-subtotal">
                                                                    <td>Subtotal</td>
                                                                    <td>RM'.number_format($total_final).'</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Shipping</td>
                                                                    <td>
                                                                ...
                                                                <tr class="order-tax">
                                                                    <td>Tax</td>
                                                                    <td>RM'.number_format($tax).'</td>
                                                                </tr>
                                                                <tr class="order-total">
                                                                    <td>Total</td>
                                                                    <td class="order-total-amount">RM'.number_format($total_final + $tax).'</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
